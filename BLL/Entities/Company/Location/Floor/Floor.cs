...
public class Floor
{
    ...
    private readonly List<Room.Room> _rooms;
    
    public Floor(Guid? id = null, string name = "", int floorNumber = 0, 
        Floorplan? floorPlan = null, List<Room.Room>? rooms = null)
    {
        _id = id ?? Guid.Empty;
        _name = name;
        _floorNumber = floorNumber;
        _floorPlan = floorPlan ?? new Floorplan();
        _rooms = rooms ?? new List<Room.Room>();
    }
    ...
    public List<Room.Room> Rooms => _rooms;
}